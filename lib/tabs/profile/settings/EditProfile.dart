    ...
    List<Widget> avatars = [
      GestureDetector(
        ...
        child: Container(
          ...
          height: 70,
          child: UserAvatar(
            user: UserProfile(user!.displayName, user!.email, user!.photoURL, true, null, preferences!.fcmToken),
      ...
      avatars.add(
        GestureDetector(
          ...
          child: Container(
            ...
            height: 70,
            child: UserAvatar(
              user: UserProfile(user!.displayName, user!.email, a, true, null, preferences!.fcmToken),
