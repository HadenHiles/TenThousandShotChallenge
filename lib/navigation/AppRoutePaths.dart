...
abstract final class AppRoutePaths {
  ...
  /// Parameterised player Challenger Road path: `/player/<id>/challenger-road`.
  static String playerChallengerRoadPathFor(String id) => '/player/$id/challenger-road';
  ...
  /// Challenger Road profile screen deep-linked to a specific trophy.
  static String profileChallengerRoadFor(String trophyId) => '/profile/challenger-road?trophyId=$trophyId';
