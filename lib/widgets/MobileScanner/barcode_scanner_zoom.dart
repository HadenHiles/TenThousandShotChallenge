...
import 'package:tenthousandshotchallenge/widgets/MobileScanner/scanned_barcode_label.dart';
import 'package:tenthousandshotchallenge/widgets/MobileScanner/scanner_button_widgets.dart';
import 'package:tenthousandshotchallenge/widgets/MobileScanner/scanner_error_widget.dart';
  ...
  Widget _buildZoomScaleSlider() {
    return ValueListenableBuilder(
      ...
      builder: (context, MobileScannerState state, child) {
        ...
        final TextStyle labelStyle = Theme.of(context).textTheme.headlineMedium!.copyWith(color: Colors.white);
