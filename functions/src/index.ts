    ...
    try {
        ...
        for (const userDoc of usersSnap.docs) {
            ...
            let templates: any[] = [
                ...
                { id: 'acc_backhand_60', style: 'accuracy', title: 'Backhand Bull', description: 'Achieve 60% accuracy on backhands in any 2 sessions.', shotType: 'backhand', goalType: 'accuracy', targetAccuracy: 60.0, sessions: 2, difficulty: 'Easy', proLevel: true, isBonus: false },
                { id: 'acc_slap_75', style: 'accuracy', title: 'Slap Shot Specialist', description: 'Achieve 55% accuracy on slap shots in any 2 sessions.', shotType: 'slap', goalType: 'accuracy', targetAccuracy: 55.0, sessions: 2, difficulty: 'Medium', proLevel: true, isBonus: false },
                ...
                { id: 'acc_wrist_easy', style: 'accuracy', title: 'Wrist Shot Precision', description: 'Achieve 60% accuracy on wrist shots in any 2 sessions in a row. Keep trying until you get it!', shotType: 'wrist', goalType: 'accuracy', targetAccuracy: 60.0, sessions: 2, difficulty: 'Easy', proLevel: true, isBonus: false },
                { id: 'acc_snap_hard', style: 'accuracy', title: 'Snap Shot Sniper', description: 'Achieve 70% accuracy on snap shots in any 3 sessions in a row. You can keep working at it all week!', shotType: 'snap', goalType: 'accuracy', targetAccuracy: 70.0, sessions: 3, difficulty: 'Hard', proLevel: true, isBonus: false },
                { id: 'acc_backhand_hardest', style: 'accuracy', title: 'Backhand Bullseye', description: 'Achieve 80% accuracy on backhands in any 4 sessions in a row. Don\'t give up if you miss early!', shotType: 'backhand', goalType: 'accuracy', targetAccuracy: 80.0, sessions: 4, difficulty: 'Hardest', proLevel: true, isBonus: false },
                { id: 'acc_slap_impossible', style: 'accuracy', title: 'Slap Shot Sharpshooter', description: 'Achieve 90% accuracy on slap shots in any 5 sessions in a row. You have all week to get there!', shotType: 'slap', goalType: 'accuracy', targetAccuracy: 90.0, sessions: 5, difficulty: 'Impossible', proLevel: true, isBonus: false },
                { id: 'acc_variety_medium', style: 'accuracy', title: 'All-Around Sniper', description: 'Achieve at least 50% accuracy on all shot types in a single session.', shotType: 'all', goalType: 'accuracy_variety', targetAccuracy: 50.0, sessions: 1, difficulty: 'Medium', proLevel: true, isBonus: false },
                // --- Ratio based ---
                { id: 'ratio_snap_slap_2to1', style: 'ratio', title: 'Snap to Slap', description: 'Take 2 snap shots for every 1 slap shot.', shotType: 'snap', goalType: 'ratio', goalValue: 2, secondaryValue: 1, difficulty: 'Medium', proLevel: false, isBonus: false },
                { id: 'ratio_even_steven', style: 'ratio', title: 'Even Steven', description: 'Take an equal number of wrist and backhand shots.', shotType: 'mixed', goalType: 'ratio_equal', goalValue: 1, secondaryValue: 1, difficulty: 'Easy', proLevel: false, isBonus: false },
                ...
                { id: 'ratio_left_right', style: 'ratio', title: 'Left vs Right', description: 'Take 2 left-handed shots for every 1 right-handed shot.', shotType: 'any', goalType: 'ratio_handed', goalValue: 2, secondaryValue: 1, difficulty: 'Medium', proLevel: false, isBonus: false },
                ...
                { id: 'ratio_evening_morning', style: 'ratio', title: 'Evening vs Morning', description: 'Take 2 evening shots for every 1 morning shot.', shotType: 'any', goalType: 'ratio_time', goalValue: 2, secondaryValue: 1, difficulty: 'Medium', proLevel: false, isBonus: false },
                { id: 'ratio_backhand_wrist_easy', style: 'ratio', title: 'Backhand Booster', description: 'Take 2 backhands for every 1 wrist shot you take.', shotType: 'backhand', goalType: 'ratio', goalValue: 2, secondaryValue: 1, difficulty: 'Easy', proLevel: false, isBonus: false },
                { id: 'ratio_backhand_snap_hard', style: 'ratio', title: 'Backhand vs Snap', description: 'Take 3 backhands for every 1 snap shot you take.', shotType: 'backhand', goalType: 'ratio', goalValue: 3, secondaryValue: 1, difficulty: 'Hard', proLevel: false, isBonus: false },
                { id: 'ratio_slap_snap_medium', style: 'ratio', title: 'Slap vs Snap', description: 'Take 2 slap shots for every 1 snap shot you take.', shotType: 'slap', goalType: 'ratio', goalValue: 2, secondaryValue: 1, difficulty: 'Medium', proLevel: false, isBonus: false },
                ...
                { id: 'variety_master', style: 'ratio', title: 'Variety Master', description: 'Take at least 5 of each shot type (wrist, snap, backhand, slap) in a single session.', shotType: 'all', goalType: 'variety', goalValue: 5, difficulty: 'Medium', proLevel: false, isBonus: false },
                // --- Consistency ---
                ...
                { id: 'consistency_nightowl', style: 'consistency', title: 'Night Owl', description: 'Complete a shooting session after 9pm two times.', shotType: '', goalType: 'late_sessions', goalValue: 2, difficulty: 'Medium', proLevel: false, isBonus: false },
                { id: 'consistency_doubleheader', style: 'consistency', title: 'Double Header', description: 'Complete two shooting sessions in one day, twice.', shotType: '', goalType: 'double_sessions', goalValue: 2, difficulty: 'Hard', proLevel: false, isBonus: false },
                ...
                { id: 'consistency_lunchbreak', style: 'consistency', title: 'Lunch Break Shooter', description: 'Complete 3 sessions between 12pm and 2pm.', shotType: '', goalType: 'lunch_sessions', goalValue: 3, difficulty: 'Easy', proLevel: false, isBonus: false },
