    ...
    try {
        ...
        for (const userDoc of usersSnap.docs) {
            ...
            let templates: any[] = [
                ...
                { id: 'ratio_left_right', style: 'ratio', title: 'Left vs Right', description: 'Take 2 left-handed shots for every 1 right-handed shot.', shotType: 'left', shotTypeComparison: 'right', primaryType: 'left', secondaryType: 'right', goalType: 'ratio_handed', goalValue: 2, secondaryValue: 1, difficulty: 'Medium', proLevel: false, isBonus: false },
                { id: 'ratio_goalie_vs_player', style: 'ratio', title: 'Goalie vs Player', description: 'For every 3 shots on net, aim 1 shot off the post.', shotType: 'on_net', shotTypeComparison: 'off_post', primaryType: 'on_net', secondaryType: 'off_post', goalType: 'ratio_goalie_post', goalValue: 3, secondaryValue: 1, difficulty: 'Hard', proLevel: false, isBonus: false },
                { id: 'ratio_evening_morning', style: 'ratio', title: 'Evening vs Morning', description: 'Take 2 evening shots for every 1 morning shot.', shotType: 'evening', shotTypeComparison: 'morning', primaryType: 'evening', secondaryType: 'morning', goalType: 'ratio_time', goalValue: 2, secondaryValue: 1, difficulty: 'Medium', proLevel: false, isBonus: false },
