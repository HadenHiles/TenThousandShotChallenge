    ...
    try {
        ...
        for (const userDoc of usersSnap.docs) {
            ...
            let templates: any[] = [
                ...
                { id: 'qty_slap_impossible', style: 'quantity', title: 'Slap Shot Marathon', description: 'Take 200 slap shots this week. Spread them out over the week!', shotType: 'slap', goalType: 'count', goalValue: 200, difficulty: 'Impossible', proLevel: false, isBonus: false },
                ...
                { id: 'qty_lefty_easy', style: 'quantity', title: 'Lefty Challenge', description: 'Take 25 shots with your non-dominant hand this week.', shotType: 'any', goalType: 'count', goalValue: 25, difficulty: 'Easy', proLevel: false, isBonus: false },
                // --- Quantity: New ---
                ...
                { id: 'qty_balanced_40', style: 'quantity', title: 'Balanced Attack', description: 'Take 10 wrist, 10 snap, 10 backhand, and 10 slap shots this week.', shotType: 'all', goalType: 'count', goalValue: 10, difficulty: 'Medium', proLevel: false, isBonus: false },
                { id: 'qty_goalie_15', style: 'quantity', title: 'Goalie Target', description: 'Hit the target 15 times in a week.', shotType: 'any', goalType: 'target_hits', goalValue: 15, difficulty: 'Medium', proLevel: false, isBonus: false },
                ...
                // --- Accuracy based (pro) ---
                { id: 'acc_wrist_70', style: 'accuracy', title: 'Wrist Wizard', description: 'Achieve 70% accuracy on wrist shots in a single session.', shotType: 'wrist', goalType: 'accuracy', targetAccuracy: 70.0, sessions: 1, difficulty: 'Medium', proLevel: true, isBonus: false },
                { id: 'acc_snap_80', style: 'accuracy', title: 'Snap Supreme', description: 'Achieve 80% accuracy on snap shots in a single session.', shotType: 'snap', goalType: 'accuracy', targetAccuracy: 80.0, sessions: 1, difficulty: 'Hard', proLevel: true, isBonus: false },
                { id: 'acc_backhand_60', style: 'accuracy', title: 'Backhand Bull', description: 'Achieve 60% accuracy on backhands in any 2 sessions this week.', shotType: 'backhand', goalType: 'accuracy', targetAccuracy: 60.0, sessions: 2, difficulty: 'Easy', proLevel: true, isBonus: false },
                { id: 'acc_slap_75', style: 'accuracy', title: 'Slap Shot Specialist', description: 'Achieve 55% accuracy on slap shots in any 2 sessions this week.', shotType: 'slap', goalType: 'accuracy', targetAccuracy: 55.0, sessions: 2, difficulty: 'Medium', proLevel: true, isBonus: false },
                { id: 'acc_variety_60', style: 'accuracy', title: 'Variety Accuracy', description: 'Achieve at least 60% accuracy on all shot types in a single session.', shotType: 'all', goalType: 'accuracy_variety', targetAccuracy: 60.0, sessions: 1, difficulty: 'Hard', proLevel: true, isBonus: false },
                { id: 'acc_morning_ace', style: 'accuracy', title: 'Morning Ace', description: 'Achieve 65% accuracy in a morning session (before 10am).', shotType: 'any', goalType: 'accuracy_morning', targetAccuracy: 65.0, sessions: 1, difficulty: 'Medium', proLevel: true, isBonus: false },
                ...
                { id: 'acc_slap_impossible', style: 'accuracy', title: 'Slap Shot Sharpshooter', description: 'Achieve 90% accuracy on slap shots in any 5 sessions in a row this week. You have all week to get there!', shotType: 'slap', goalType: 'accuracy', targetAccuracy: 90.0, sessions: 5, difficulty: 'Impossible', proLevel: true, isBonus: false },
                { id: 'acc_variety_medium', style: 'accuracy', title: 'All-Around Sniper', description: 'Achieve at least 50% accuracy on all shot types in a single session this week.', shotType: 'all', goalType: 'accuracy_variety', targetAccuracy: 50.0, sessions: 1, difficulty: 'Medium', proLevel: true, isBonus: false },
                // --- Ratio based ---
                { id: 'ratio_snap_slap_2to1', style: 'ratio', title: 'Snap to Slap', description: 'Take 2 snap shots for every 1 slap shot this week.', shotType: 'snap', goalType: 'ratio', goalValue: 2, secondaryValue: 1, difficulty: 'Medium', proLevel: false, isBonus: false },
                { id: 'ratio_even_steven', style: 'ratio', title: 'Even Steven', description: 'Take an equal number of wrist and backhand shots this week.', shotType: 'mixed', goalType: 'ratio_equal', goalValue: 1, secondaryValue: 1, difficulty: 'Easy', proLevel: false, isBonus: false },
                { id: 'ratio_triple_threat', style: 'ratio', title: 'Triple Threat', description: 'Take 3 snap shots for every 1 backhand and 1 slap shot combined.', shotType: 'snap', goalType: 'ratio', goalValue: 3, secondaryValue: 2, difficulty: 'Hard', proLevel: false, isBonus: false },
                { id: 'ratio_left_right', style: 'ratio', title: 'Left vs Right', description: 'Take 2 left-handed shots for every 1 right-handed shot this week.', shotType: 'any', goalType: 'ratio_handed', goalValue: 2, secondaryValue: 1, difficulty: 'Medium', proLevel: false, isBonus: false },
                { id: 'ratio_goalie_vs_player', style: 'ratio', title: 'Goalie vs Player', description: 'For every 3 shots on net, take 1 shot off the post.', shotType: 'any', goalType: 'ratio_goalie_post', goalValue: 3, secondaryValue: 1, difficulty: 'Hard', proLevel: false, isBonus: false },
                { id: 'ratio_evening_morning', style: 'ratio', title: 'Evening vs Morning', description: 'Take 2 evening shots for every 1 morning shot this week.', shotType: 'any', goalType: 'ratio_time', goalValue: 2, secondaryValue: 1, difficulty: 'Medium', proLevel: false, isBonus: false },
                ...
                { id: 'ratio_slap_snap_medium', style: 'ratio', title: 'Slap vs Snap', description: 'Take 2 slap shots for every 1 snap shot you take this week.', shotType: 'slap', goalType: 'ratio', goalValue: 2, secondaryValue: 1, difficulty: 'Medium', proLevel: false, isBonus: false },
                { id: 'chip_shot_king', style: 'ratio', title: 'Chip Shot King', description: 'Alternate forehand (snap) and backhand shots for an entire session!', shotType: 'mixed', goalType: 'alternate', goalValue: 1, difficulty: 'Hard', proLevel: false, isBonus: false },
                { id: 'variety_master', style: 'ratio', title: 'Variety Master', description: 'Take at least 5 of each shot type (wrist, snap, backhand, slap) in a single session this week.', shotType: 'all', goalType: 'variety', goalValue: 5, difficulty: 'Medium', proLevel: false, isBonus: false },
                // --- Consistency ---
                { id: 'consistency_earlybird', style: 'consistency', title: 'Early Bird', description: 'Complete a shooting session before 7am three times this week.', shotType: '', goalType: 'early_sessions', goalValue: 3, difficulty: 'Hard', proLevel: false, isBonus: false },
                { id: 'consistency_nightowl', style: 'consistency', title: 'Night Owl', description: 'Complete a shooting session after 9pm two times this week.', shotType: '', goalType: 'late_sessions', goalValue: 2, difficulty: 'Medium', proLevel: false, isBonus: false },
                { id: 'consistency_doubleheader', style: 'consistency', title: 'Double Header', description: 'Complete two shooting sessions in one day, twice this week.', shotType: '', goalType: 'double_sessions', goalValue: 2, difficulty: 'Hard', proLevel: false, isBonus: false },
                { id: 'consistency_weekendwarrior', style: 'consistency', title: 'Weekend Warrior', description: 'Complete a session on both Saturday and Sunday this week.', shotType: '', goalType: 'weekend_sessions', goalValue: 2, difficulty: 'Medium', proLevel: false, isBonus: false },
                ...
                { id: 'consistency_lunchbreak', style: 'consistency', title: 'Lunch Break Shooter', description: 'Complete 3 sessions between 12pm and 2pm this week.', shotType: '', goalType: 'lunch_sessions', goalValue: 3, difficulty: 'Easy', proLevel: false, isBonus: false },
                { id: 'consistency_daily_easy', style: 'consistency', title: 'Daily Shooter', description: 'Shoot pucks every day this week.', shotType: '', goalType: 'streak', goalValue: 7, difficulty: 'Hard', proLevel: false, isBonus: false },
                ...
                { id: 'consistency_morning_medium', style: 'consistency', title: 'Morning Warrior', description: 'Complete 3 morning shooting sessions this week (before 10am).', shotType: '', goalType: 'morning_sessions', goalValue: 3, difficulty: 'Medium', proLevel: false, isBonus: false },
                // --- Progress ---
                ...
                { id: 'progress_backhand_improve_medium', style: 'progress', title: 'Backhand Progress', description: 'Improve your backhand accuracy by 7% this week.', shotType: 'backhand', goalType: 'improvement', improvement: 7, difficulty: 'Medium', proLevel: true, isBonus: false },
                { id: 'progress_slap_improve_medium', style: 'progress', title: 'Slap Shot Progress', description: 'Improve your slap shot accuracy by 8% this week.', shotType: 'slap', goalType: 'improvement', improvement: 8, difficulty: 'Medium', proLevel: true, isBonus: false },
                { id: 'progress_variety_improve_hard', style: 'progress', title: 'All-Around Progress', description: 'Improve your accuracy by at least 5% on all shot types this week.', shotType: 'all', goalType: 'improvement_variety', improvement: 5, difficulty: 'Hard', proLevel: true, isBonus: false },
                { id: 'progress_streak_3days', style: 'progress', title: 'Three Day Streak', description: 'Improve your accuracy on any shot type for 3 days in a row this week.', shotType: 'any', goalType: 'improvement_streak', improvement: 1, days: 3, difficulty: 'Medium', proLevel: true, isBonus: false },
                { id: 'progress_evening_improve', style: 'progress', title: 'Evening Improver', description: 'Improve your overall accuracy by 6% this week.', shotType: 'any', goalType: 'improvement_evening', improvement: 6, difficulty: 'Medium', proLevel: true, isBonus: false },
                { id: 'progress_target_hits', style: 'progress', title: 'Target Hitter', description: 'Hit 100 targets this week.', shotType: 'any', goalType: 'target_hits_increase', improvement: 100, difficulty: 'Easy', proLevel: true, isBonus: false },
                { id: 'progress_consistency_sessions', style: 'progress', title: 'Consistent Improver', description: 'Improve your accuracy in at least 4 different sessions this week.', shotType: 'any', goalType: 'improvement_sessions', improvement: 1, sessions: 4, difficulty: 'Hard', proLevel: true, isBonus: false },
            ];
