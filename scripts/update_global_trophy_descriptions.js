...
const TROPHIES = [
    ...
    { id: 'g_slap_accuracy_50', name: 'Slap Starter', desc: "35%+ slap accuracy in a session (10+ slap shots). Slap shots are twice as hard \u2014 getting a third on target is real.", category: 'accuracy', tier: 'common', proOnly: true },
    { id: 'g_slap_accuracy_60', name: 'Controlled Chaos', desc: '45%+ slap accuracy in a session (15+ slap shots). Not all bombs are wild.', category: 'accuracy', tier: 'common', proOnly: true },
    { id: 'g_slap_accuracy_70', name: 'Locked In', desc: '55%+ slap accuracy in a session (15+ slap shots). That bomb has a target.', category: 'accuracy', tier: 'uncommon', proOnly: true },
    { id: 'g_slap_accuracy_75', name: 'Slap Precision', desc: '60%+ slap accuracy in a session (15+ slap shots). Rare power and precision.', category: 'accuracy', tier: 'uncommon', proOnly: true },
    { id: 'g_slap_accuracy_80', name: 'Precision Bomb', desc: '65%+ slap accuracy in a single training session (min. 20 slap shots). Elite-level power and precision.', category: 'accuracy', tier: 'rare', proOnly: true },
    { id: 'g_slap_accuracy_85', name: 'Slap Expert', desc: '70%+ slap accuracy in a session (20+ slap shots). Pinpoint power.', category: 'accuracy', tier: 'rare', proOnly: true },
    ...
    { id: 'g_slap_accuracy_90', name: 'Heat Seeking', desc: '75%+ slap accuracy in a single training session (min. 20 slap shots). That bomb locks on.', category: 'accuracy', tier: 'epic', proOnly: true },
    { id: 'g_slap_accuracy_95', name: 'Slap Surgeon', desc: '80%+ slap accuracy in a single training session (min. 20 slap shots). The bomb is now guided.', category: 'accuracy', tier: 'epic', proOnly: true },
    { id: 'g_slap_perfect', name: 'Bomb Perfect', desc: '100% slap accuracy in a session with 20+ slap shots. Full power. Full precision. Nothing missed.', category: 'accuracy', tier: 'legendary', proOnly: true },
